...
VARIANTS_GROUPS = [["Minimal.cnflingeling","Minimal.cnfmapleSat"],["OP.cnflingeling","OP.cnfmapleSat"],["9999.cnflingeling","9999.cnfmapleSat"],["33.cnflingeling","33.cnfmapleSat"],["Greedy.cnflingeling","Greedy.cnfmapleSat"]]
...
with open("summary.tex","w") as outFile:    
    ...
    # Print cactus plot
    for markedGroup in VARIANTS_GROUPS:
        ...
        for i,filename in enumerate(performances):
            ...
            if not filename in markedGroup:
